...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* Base Layer
   * ,-------------------------------------------------------------------------.
   * | Esc |  Q  |  W  |  E  |  R  |  T  |  Y  |  U  |  I  |  O  |  P  |BkSlash|
   * |-------------------------------------------------------------------------+
   * |Tab/L3|  A  |  S  |  D  |  F  |  G  |  H  |  J  |  K  |  L  |  ;  |   '  |
   * |-------------------------------------------------------------------------+
   * | Shift |  Z  |  X  |  C  |  V  |  B  |  N  |  M  |  ,  |  .  |  /  |Sh/En|
   * |-------------------------------------------------------------------------+
   * | Ctrl| Alt | Gui | App |L2/BkSp|   Space   |L1/ENT| Left| Down|  Up |Right|
   * `-------------------------------------------------------------------------'
   */
...
LAYOUT(
  ...
  KC_LCTL, KC_LALT, KC_LGUI, KC_APP,  LT2_BSPC,      KC_SPC,     LT1_ENT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
LAYOUT( /* Left */
  ...
  /* FN Layer 2
   * ,-------------------------------------------------------------------------.
   * |Reset| Calc|Webhm| Mail| Comp|     |     |     |Insert|     |PrtSc|       |
   * |-------------------------------------------------------------------------+
   * |      |     |     |     |     |     |Left |Down | Up  |Right|     |      |
   * |-------------------------------------------------------------------------+
   * |       |    |     |     |     |     |     |     |     |     |     |     |
...
LAYOUT( /* Tab */
  RESET,  KC_CALC, KC_WHOM, KC_MAIL, KC_MYCM, _______, _______, _______, KC_INS, _______, KC_PSCR, _______,
