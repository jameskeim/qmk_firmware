...
[0] = LAYOUT_tkl_ansi(
                ...
                KC_LCTL,XXXXXXX,KC_LALT,                KC_SPC,                                   KC_RALT,KC_RGUI, MFUNC,   KC_RCTL,   KC_LEFT, KC_DOWN, KC_RGHT),
...
[1] = LAYOUT_tkl_ansi(
                ...
                CTLCAPS,KC_LGUI,KC_LALT,                SPCFUNC,                         KC_RALT,KC_RGUI, MFUNC,   KC_RCTL,   KC_LEFT, KC_DOWN, KC_RGHT),
  ...
  /* MACRODOWN only works in this function */
  	switch(id) {
    	...
    	case M_VERSION:
      	...
      	case M_THINGS:
      		if (record->event.pressed) {
        		SEND_STRING("PufVumMep@6"SS_TAP(X_ENTER));}
      	break;
      	case M_MYKEEB:
      		if (record->event.pressed) {
